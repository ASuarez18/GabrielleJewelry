...
function HeadlineCards() {
  return (
    <div>
      <div>
        <h1 className='text-violet-400 font-bold text-4xl text-center'>Nuevos productos</h1>
      </div>
      ...
      <div className='rounded-xl relative'>
        ...
        <div className='absolute w-full h-full bg-black/50 rounded-xl text-white'>
          <p className='font-bold text-2xl px-2 pt4'>Sun's Out, BOGO's Out</p>
      ...
      {
        // TODO: Make a reusable HeadlineCard card component
      }
      ...
      <div className='rounded-xl relative'>
        {/* Overlay */}
        <div className='absolute w-full h-full bg-black/50 rounded-xl text-white'>
          <p className='font-bold text-2xl px-2 pt4'>New Restaurants</p>
      ...
      <div className='rounded-xl relative'>
        {/* Overlay */}
        <div className='absolute w-full h-full bg-black/50 rounded-xl text-white'>
          <p className='font-bold text-2xl px-2 pt4'>We Deliver Desserts Too</p>
