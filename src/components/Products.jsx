...
function Products() {
  ...
  return (
    <div className='max-w-[1640px] m-auto px-4 py12'>
      <h1 className='text-violet-400 font-bold text-4xl text-center'>Productos Disponibles</h1>
      ...
      <div className='flex flex-col lg:flex-row justify-between'>
        ...
        <div>
          ...
          <div className='flex justify-between flex-wrap'>
            <button onClick={()=> setProducts(data)} className='m-1 border-violet-400 text-violet-400 hover:bg-violet-400 hover:text-white'>Todo</button>
            <button onClick={()=> filterByType('pulsera')}  className='m-1 border-violet-400 text-violet-400 hover:bg-violet-400 hover:text-white'>Pulseras</button>
            <button onClick={()=> filterByType('collar')} className='m-1 border-violet-400 text-violet-400 hover:bg-violet-400 hover:text-white'>Collares</button>
        ...
        {Products.map((item, index) => (
          ...
          >
            ...
            <div className='px-2 py-4'>
              ...
              <p><span className='font-semibold'>Medida:</span> {item.size}</p>
              {/* <p>
